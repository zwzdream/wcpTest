...
//		Session session = sessionFatory.getCurrentSession();
//		SQLQuery sqlquery = session
//				.createSQLQuery("SELECT a.USERID as userid,a.ID as id,a.ORGANIZATIONID as organizationid,a.POSTID as postid FROM alone_auth_userorgpost a LEFT JOIN alone_auth_post  b ON a.POSTID=b.ID WHERE b.TYPE='1' and a.USERID=?");
