...
public class DoQueryTest {
	private static File indexDir = new File(FarmLuceneFace.getFileDirPath()
...
//		 DocIndexImpl dii = (DocIndexImpl) DocIndexImpl.getInstance(indexDir,"testId");
...
//		// new IKAnalyzer());
//		String[] fields = { "TEXT" };
//		QueryParser mqp = new MultiFieldQueryParser(Version.LUCENE_35, fields,
//				new IKAnalyzer());
