				...
				<tr>
					<td class="title">
						<a href="javascript:void(0)" id="mb" class="easyui-menubutton"
							data-options="menu:'#mm',iconCls:'icon-graphic-design',plain:false" style="background:#1890FF;">内容</a>
		...
		<div class="div_button" style="text-align: center; padding: 4px;">
			<c:if test="${pageset.operateType ==1}">
				<a id="dom_add_entityFarmdoc" href="javascript:void(0)"
					iconCls="icon-save" class="easyui-linkbutton" style="color: #000000;background:#1890FF;">增加</a>
			</c:if>
			<c:if test="${pageset.operateType ==2}">
				<a id="dom_edit_entityFarmdoc" href="javascript:void(0)"
					iconCls="icon-save" class="easyui-linkbutton" style="color: #000000;background:#1890FF;">修改</a>
			</c:if>
