...
<div class="easyui-layout" data-options="fit:true">
	...
	<div data-options="region:'center'">
		<form id="dom_formDocfile">
			<input type="hidden" id="entity_id" id"
				value="${entity.id}">
				...
				<tr>
					...
					<td colspan="2">
						<input type="text" style="width: 360px;"
							class="easyui-validatebox"
							data-options="required:true,validType:[,'maxLength[32]']"
							id="entity_name" name" value="${entity.name}">
				...
				<tr>
					...
					<td>
						<input type="text" style="width: 360px;"
							...
							id="entity_len" len" value="${entity.len}">
					</td>
					<td class="title">
						扩展名:
					</td>
					<td>
						<input type="text" style="width: 360px;"
							...
							id="entity_exname" exname" value="${entity.exname}">
					</td>
				</tr>
				<tr>
					<td class="title">
					...
					<td>
						...
						<select id="entity_type" type" val="${entity.type}">
							<option value="1">
								图片
							</option>
							<option value="0">
					...
					<td>
						<select id="entity_pstate" pstate"
							val="${entity.pstate}">
							<option value="1">
								使用
							</option>
				...
				<tr>
					...
					<td colspan="3">
						<input type="text" style="width: 360px;"
							...
							id="entity_dir" dir" value="${entity.dir}">
					</td>
				</tr>
				<c:if test="${entity.type=='1'}">
					<tr>
						<td colspan="4">
							<img src="${entity.url}" style="max-width: 100%" />
						</td>
					</tr>
				</c:if>
			</table>
	...
	<div data-options="region:'south',border:false">
		<div class="div_button" style="text-align: center; padding: 4px;">
			...
			<a id="dom_cancle_formDocfile" href="javascript:void(0)"
				...
				style="color: #000000;background:#1890FF;">取消</a>
		</div>
	</div>
</div>
