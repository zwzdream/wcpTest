		...
		<div class="div_button" style="text-align: center; padding: 4px;">
			<c:if test="${pageset.operateType==1}">
				<a id="dom_add_entityDoctype" href="javascript:void(0)"
					iconCls="icon-save-add" class="easyui-linkbutton" style="color: #000000;background:#1890FF;">增加</a>
			</c:if>
			<c:if test="${pageset.operateType==2}">
				<a id="dom_edit_entityDoctype" href="javascript:void(0)"
					iconCls="icon-save-edit" class="easyui-linkbutton" style="color: #000000;background:#1890FF;">修改</a>
			</c:if>
