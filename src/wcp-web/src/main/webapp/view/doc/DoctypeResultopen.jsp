	...
	<div data-options="region:'west',split:true,border:false"
		...
		<div class="TREE_COMMON_BOX_SPLIT_DIV">
			<a id="DoctypeTreeReload" href="javascript:void(0)"
				...
				iconCls="icon-reload" style="background:#1890FF;">刷新菜单</a> <a id="DoctypeTreeOpenAll"
				href="javascript:void(0)" class="easyui-linkbutton"
				 iconCls="icon-sitemap" style="background:#1890FF;">全部展开</a>
		</div>
				...
				<table class="editTable">
					...
					<tr style="text-align: center;">
						<td colspan="4"><a id="a_search" href="javascript:void(0)"
							class="easyui-linkbutton" iconCls="icon-search" style="background:#1890FF;">查询</a> <a
							id="a_reset" href="javascript:void(0)" class="easyui-linkbutton"
							iconCls="icon-cancel" style="background:#1890FF;">清除条件</a></td>
					</tr>
				</table>
			</form>
		</div>
