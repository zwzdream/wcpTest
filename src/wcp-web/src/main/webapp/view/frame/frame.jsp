...
<body class="easyui-layout">
	...
	<div data-options="region:'north',border:false"
		style="height: 60px; border: 0px; padding: 0px; overflow: hidden; background: #1c6d9f;">
	...
	<PF:IfParameterEquals key="config.auth.check.url" val="false">
	...
	<div data-options="region:'center'">
		<div class="easyui-tabs" id="frame_tabs" style="overflow: hidden;"
			...
			<div title="首页-附件管理" style="overflow: hidden;">
