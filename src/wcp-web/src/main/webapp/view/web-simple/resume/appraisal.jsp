	...
	<div class="containerbox">
		<div class="container ">
			<div class="row  column_box">
				<div class="col-md-12">
					<h3>${USEROBJ.name}-自我评价<a class="resum_button btn btn-info btn-sm"
			...
			<div class="row ">
				<div class="widget-box shadow-box" style="min-width: 800px;">
					...
					<div class="stream-list p-stream">
						<form role="form" action="resume/appraisalCommit.do" id="SubmitFormId" method="post">
							...
							<table class="table resum_unit" style="font-size: 12px;">
								<tr>
									...
									<td>
										<textarea id="appraisalid" name="appraisal"
											style="height: 90px; width: 100%;">${resumeappraisal.appraisal}</textarea>
									</td>
								</tr>
								<tr>
									<td class="resum_title">职业目标</td>
									<td>
										<textarea id="careergoalsid" name="careergoals"
											style="height: 90px; width: 100%;">${resumeappraisal.careergoals}</textarea>
									</td>
								</tr>
								<tr>
