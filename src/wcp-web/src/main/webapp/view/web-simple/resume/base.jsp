					...
					<div class="stream-list p-stream">
						<form role="form" action="resume/baseCommit.do" id="SubmitFormId"
							...
							<table class="table table-striped  resum_unit"
								...
								<tr>
									<td class="resum_title">性别<span class="alertMsgClass">*</span></td>
									...
									<td rowspan="6"
										...
										<div class=" resum_unit"
											style="font-size: 12px; text-align: center; margin-left: -50px;">
								...
								<tr>
									...
									<td class="resum_title">参加工作年份<span class="alertMsgClass">*</span></td>
								...
								<tr>
									<td class="resum_title">最高学历<span class="alertMsgClass">*</span></td>
									...
									<td class="resum_title">户口所在地<span class="alertMsgClass">*</span></td>
									<td><input type="text" class="form-control"
										id="registeredid" name="registered" value="${base.registered}"></td>
								</tr>
								<tr>
									<td class="resum_title">居住所在地<span class="alertMsgClass">*</span></td>
								...
								<tr>
									<td class="resum_title">手机号码<span class="alertMsgClass">*</span></td>
									<td><input type="text" class="form-control"
								...
								<tr>
									<td colspan="5" style="text-align: center;"><button
											type="button" id="SubmitButtonId" class="btn btn-info">提交</button>
										<span class="alertMsgClass" id="errormessageShowboxId"></span></td>
								</tr>
							</table>
						</form>
					</div>
