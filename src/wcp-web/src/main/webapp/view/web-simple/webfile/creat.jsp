...
<script type="text/javascript"
	...
	<!-- 将上面的引入文件写在vx.css上面，不然vx.css有些东西没做效 -->
<jsp:include page="../atext/include-web.jsp"></jsp:include>
					...
					<form role="form" action="webfile/addsubmit.do"
						...
						<div class="row">
							...
							<span style="color:green">
								允许上传附件类型为png,jpg,jpeg,zip,doc,docx,xls,xlsx,pdf,ppt,pptx,
								&nbsp;web,rar,txt,flv,mp3,mp4,dcr，最大10M
							</span>
									...
									<div class="panel-heading center-block webfile-buttonplus"
										...
										<div style="float: left;">
											<input type="button" class="btn btn-info btn-xs center-block"
												style="padding: 0px; padding-bottom: 8px;background: #1890FF;border-color: #1890FF;" id="uploadButton"
												value="上传资源" />
										</div>
