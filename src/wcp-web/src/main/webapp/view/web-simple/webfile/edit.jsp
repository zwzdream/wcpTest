...
<script type="text/javascript"
	...
	<jsp:include page="../atext/include-web.jsp"></jsp:include>
<link href="text/lib/bootstrap/css/vx.css"
	rel="stylesheet">
</head>
<style>
<!--
...
<body>
	...
	<div class="containerbox">
		<div class="container ">
			<div class="row  column_box" style="margin-top:70px">
				<div class="col-md-3  visible-lg visible-md"></div>
				<div class="col-md-9">
					<div class="row">
						<div class="col-md-12">
							<ol class="breadcrumb" style="border-left:3px solid #1890FF;border-radius:0">
					...
					<form role="form" action="webfile/editCommit.do"
						...
						<div class="row">
							...
							<span style="color:green">
								允许上传附件类型为png,jpg,jpeg,zip,doc,docx,xls,xlsx,pdf,ppt,pptx,web,rar,txt,flv,mp3,mp4,dcr，最大10M
							</span>
									...
									<div class="panel-body" id="fileListId">
										...
										<c:forEach var="file" items="${doce.files }">
											<div id="file_${file.id }">
												<input type="hidden" name="fileId" value="${file.id }" /> <span>${file.name }</span>
						...
						<div class="row">
						 ...
						 <div class="row">
							<div class="col-md-4">
								<div class="form-group">
									<label for="exampleInputEmail1" style="display: none"> 是否发布到小组 </label> <select
										class="form-control" name="docgroup" id="docgroupId" style="display: none"
							...
							<div class="col-md-4">
								<div class="form-group">
									<label for="exampleInputEmail1" style="display: none"> 编辑权限 <span
										class="alertMsgClass">*</span>
									</label> <select class="form-control" name="writetype" id="writetypeId" style="display: none"
							...
							<div class="col-md-4">
								<div class="form-group">
									<label for="exampleInputEmail1" style="display: none"> 阅读权限 <span
										class="alertMsgClass">*</span>
									</label> <select class="form-control" name="readtype" id="readtypeId" style="display: none"
				...
				.uploadify(
						{
							...
							'fileTypeDesc' : '${filetypestr}', // 支持的文件格式，写filetypeExts该参数必须写jpg,jpeg,png,gif,wav,mp3,mp4,zip
							'fileTypeExts' : '${filetypestrplus}', //控制可上传文件的扩展名，启用本项时需同时声明fileDesc *.jpg;*.jpeg;*.png;*.gif;*.wav;*.zip;*.mp3;*.mp4
