...
public interface WcpWebFileManagerInter {
	 ...
	 * @return 资源文件ID
	 */
	public DocEntire creatWebFile(String fcontent,List<String> fileid, String typeId, String fileName, String tag, String groupId, String text,
	 ...
	 * @return
	 */
	public DocEntire editWebFile(String fileContent,String docid, List<String> fileid, String typeId, String fileName, String tag, String groupId,
