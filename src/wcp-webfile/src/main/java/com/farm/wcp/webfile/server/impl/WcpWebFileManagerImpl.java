...
public class WcpWebFileManagerImpl implements WcpWebFileManagerInter {
	...
	@Override
	@Transactional
	public DocEntire creatWebFile(String fcontent,List<String> fileid, String typeId, String fileName, String tag, String groupId,
			String text, POP_TYPE editPop, POP_TYPE readPop, LoginUser currentUser) {
		Doc doc = new Doc();
		doc.setTitle(fileName);
		doc.setTagkey(tag);
		//doc.setFilecontent(fcontent);
		doc.setDomtype("5");
	...
	@Override
	@Transactional
	public DocEntire editWebFile(String fileContent,String docid, List<String> fileid, String typeId, String fileName, String tag,
